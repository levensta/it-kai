...
@section('content')
    ...
    <p>
        <ul class="list-inline">
            ...
            <li><a href="{{ route('admin.tests.index') }}?show_deleted=1" style="{{ request('show_deleted') == 1 ? 'font-weight: 700' : '' }}">Удаленные</a></li>
        </ul>
    </p>
...
@section('javascript') 
    <script>
        @can('test_delete')
                ...
                @else
                    window.route_mass_crud_entries_destroy = '{{ route('admin.tests.mass_permadel') }}';
                @endif
        @endcan
