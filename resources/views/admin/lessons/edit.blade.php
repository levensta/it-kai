...
@section('content')
    ...
    <div class="panel panel-default">
        ...
        <div class="panel-body">
            ...
            <div class="row">
                <div class="col-xs-12 form-group">
                    {!! Form::label('slug', 'Ссылка', ['class' => 'control-label']) !!} <i><u title="Название ссылки, которое будет в адресной строке. Например, compscience.ru/lesson/example">?</u></i>
            ...
            <div class="row">
                <div class="col-xs-12 form-group">
                    ...
                    @endif
                    {!! Form::label('lesson_image', 'Изображение к уроку', ['class' => 'control-label']) !!}
                    {!! Form::file('lesson_image', ['class' => 'form-control', 'style' => 'margin-top: 4px;']) !!}
                    {!! Form::hidden('lesson_image_max_size', 16) !!}
            ...
            <div class="row">
                <div class="col-xs-12 form-group">
                    {!! Form::label('short_text', 'Короткое описание', ['class' => 'control-label']) !!}
            ...
            <div class="row">
                <div class="col-xs-12 form-group">
                    {!! Form::label('full_text', 'Текст урока', ['class' => 'control-label']) !!}
            ...
            <div class="row">
                <div class="col-xs-12 form-group">
                    {!! Form::label('downloadable_files', 'Загружаемые файлы', ['class' => 'control-label']) !!}
