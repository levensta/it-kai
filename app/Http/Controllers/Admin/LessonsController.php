...
class LessonsController extends Controller
{
    ...
    public function create()
    {
        ...
        $courses = \App\Course::ofTeacher()->get()->pluck('title', 'id')->prepend('Выберите', '');
    ...
    public function show($id)
    {
        ...
        $courses = \App\Course::get()->pluck('title', 'id')->prepend('Выберите', '');$tests = \App\Test::where('lesson_id', $id)->get();
    ...
    public function massPerma_del(Request $request)
    {
        ...
        if ($request->input('ids')) {
            $entries = Lesson::onlyTrashed()->whereIn('id', $request->input('ids'))->get();
