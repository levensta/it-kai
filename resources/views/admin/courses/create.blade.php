...
@section('content')
    ...
    <div class="panel panel-default">
        ...
        <div class="panel-body">
            ...
            <div class="row">
                <div class="col-xs-12 form-group">
                    {!! Form::label('slug', 'Ссылка', ['class' => 'control-label']) !!} <i><u title="Название ссылки, которое будет в адресной строке. Например, compscience.ru/courses/example">?</u></i>
            ...
            <div class="row">
                <div class="col-xs-12 form-group">
                    {!! Form::label('course_image', 'Изображение курса', ['class' => 'control-label']) !!}
                    {!! Form::file('course_image', ['class' => 'form-control', 'style' => 'margin-top: 4px;']) !!}
                    {!! Form::hidden('course_image_max_size', 16) !!}
            ...
            <div class="row">
                <div class="col-xs-12 form-group">
                    {!! Form::label('start_date', 'Дата старта*', ['class' => 'control-label']) !!}
