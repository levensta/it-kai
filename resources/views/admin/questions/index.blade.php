...
@section('content')
    ...
    <p>
        <ul class="list-inline">
            ...
            <li><a href="{{ route('admin.questions.index') }}?show_deleted=1" style="{{ request('show_deleted') == 1 ? 'font-weight: 700' : '' }}">Удаленные</a></li>
        </ul>
    </p>
    ...
    <div class="panel panel-default">
        ...
        <div class="panel-body table-responsive">
            <table class="table table-bordered table-striped {{ count($questions) > 0 ? 'datatable' : '' }} @can('question_delete') dt-select @endcan">
                <thead>
                    <tr>
                        @can('question_delete')
...
@section('javascript') 
    <script>
        @can('question_delete')
                ...
                @else
                    window.route_mass_crud_entries_destroy = '{{ route('admin.questions.mass_permadel') }}';
                @endif
        @endcan
