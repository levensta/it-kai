...
class TestsController extends Controller
{
    ...
    public function create()
    {
        ...
        $courses = $courses->pluck('title', 'id')->prepend('Выберите', '');
        $lessons = \App\Lesson::whereIn('course_id', $courses_ids)->get()->pluck('title', 'id')->prepend('Выберите', '');
    ...
    public function massPerma_del(Request $request)
    {
        ...
        if ($request->input('ids')) {
            $entries = Test::onlyTrashed()->whereIn('id', $request->input('ids'))->get();
