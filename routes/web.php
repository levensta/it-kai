...
Route::post('course/join', ['uses' => 'CoursesController@join', 'as' => 'courses.join']);
...
Route::group(['middleware' => ['admin'], 'prefix' => 'admin', 'as' => 'admin.'], function () {
    ...
    Route::post('lessons_mass_permadel', ['uses' => 'Admin\LessonsController@massPerma_del', 'as' => 'lessons.mass_permadel']);

    Route::resource('questions', 'Admin\QuestionsController');
    Route::post('questions_mass_destroy', ['uses' => 'Admin\QuestionsController@massDestroy', 'as' => 'questions.mass_destroy']);
    Route::post('questions_mass_permadel', ['uses' => 'Admin\QuestionsController@massPerma_del', 'as' => 'questions.mass_permadel']);
    ...
    Route::post('questions_options_mass_permadel', ['uses' => 'Admin\QuestionsOptionsController@massPerma_del', 'as' => 'questions_options.mass_permadel']);
    ...
    Route::post('tests_mass_permadel', ['uses' => 'Admin\TestsController@massPerma_del', 'as' => 'tests.mass_permadel']);
